(function ($) {
  ...
  var show_char = 250;
  var ellipses = "... ";
  $(".testimonails_two_text > p").each(function (index) {
    var $longText = $(this);
    ...
    if (content.length > show_char) {
      ...
      var html =
        ...
        secondPart +
        "</span><span class='btn btn-xs cursor-pointer read-more'><i class='fa fa-angle-down'></i> Ver mais</span>";
  ...
  $(".read-more").click(function (e) {
    e.preventDefault();
    var $this = $(this);
    $this.html() == '<i class="fa fa-angle-down"></i> Ver mais'
      ? $this.html('<i class="fa fa-angle-up"></i> Ver menos')
      : $this.html('<i class="fa fa-angle-down"></i> Ver mais');
  ...
  if ($(".main-nav__main-navigation li.dropdown ul").length) {
    $(".main-nav__main-navigation li.dropdown")
      .children("a")
      .append(
        '<button class="dropdown-btn" title="Portfólio"><i class="fa fa-angle-down"></i></button>'
      );
  }
...
function buscarBlog() {
    var url = vsUrl + "buscar/" + $("#campo_buscar_blog").val();
    window.location.href = url;
    //    alert(vsUrl);
}
$("#botao_buscar_blog").click(function () {
    buscarBlog();
});
jQuery('#campo_buscar_blog').keypress(function (event) {
