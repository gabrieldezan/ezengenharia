                    ...
                    "columns": [
                        {"data": "id_banner"},
                        {
                            "render": function (data, type, row) {
                                return "<img src=\"" + vsUrl + "uploads/banner/" + row.imagem + "\" class=\"img-fluid\" style=\"max-height:170px;\" />";
                            }
                        },
                        {"data": "titulo"},
                        {"data": "posicao"},
                        {
                            "render": function (data, type, row) {
                                return "<span class=\"label label-" + row.link_nova_aba_class + "\">" + row.link_nova_aba + "</span>";
                            }
                        },
                        {
                            "render": function (data, type, row) {
                                return "\
                                    ...
                                    <button type=\"button\" class=\"btn btn-danger btn-sm\" onclick=\"confirma_exclusao_registro(" + row.id_banner + ", 'banner', 'banner', '" + row.imagem + "', '', '', '', '');\" data-toggle=\"tooltip\" title=\"Remover " + row.titulo + "\"><i class=\"far fa-trash-alt fa-fw\" aria-hidden=\"true\"></i></button>\
                                ";
                            }
                        }
                    ],
