                    ...
                    "columns": [
                        {"data": "id_galeria_imagem"},
                        {
                            "render": function (data, type, row) {
                                return "<img src=\"" + vsUrl + "uploads/galeria_imagem/" + row.imagem1 + "\" class=\"img-fluid\" style=\"height:170px;\" />";
                            }
                        },
                        {"data": "titulo"},
                        {
                            "render": function (data, type, row) {
                                return "\
                                    ...
                                    <button type=\"button\" class=\"btn btn-danger btn-sm\" onclick=\"confirma_exclusao_registro(" + row.id_galeria_imagem + ", 'galeria_imagem', 'galeria_imagem', '" + row.imagem1 + "', '" + row.imagem2 + "', '" + row.imagem3 + "', '" + row.imagem4 + "', '" + row.imagem5 + "');\" data-toggle=\"tooltip\" title=\"Remover " + row.titulo + "\"><i class=\"far fa-trash-alt fa-fw\" aria-hidden=\"true\"></i></button>\
                                ";
                            }
                        }
                    ],
