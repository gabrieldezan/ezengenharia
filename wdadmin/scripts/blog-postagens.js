...
function carrega_blog_postagens() {
    ...
    $.ajax({
        ...
        data: ({
            ...
            viFiltroIdAutores: $("#inputFiltroIdAutores").val()
        }),
                    ...
                    "columns": [
                        ...
                        },
                        {
                            "render": function (data, type, row) {
                                    ...
                                    <a href=\"https://giraldis.cnt.br/post/" + row.url_amigavel + "\" target=\"_blank\" class=\"btn btn-sm btn-success\" data-toggle=\"tooltip\" data-placement=\"left\" title=\"Acessar " + row.titulo + "\"><i class=\"fas fa-external-link-alt\"></i></a>&nbsp;\n\
                                    <button type=\"button\" class=\"btn btn-danger btn-sm\" onclick=\"confirma_exclusao_registro(" + row.id_blog_postagem + ", 'blog_postagem', 'blog_postagem', '" + row.imagem + "', '', '', '', '');\" data-toggle=\"tooltip\" title=\"Remover " + row.titulo + "\"><i class=\"far fa-trash-alt fa-fw\" aria-hidden=\"true\"></i></button>\
                                ";
                            }
                        }
                    ],
