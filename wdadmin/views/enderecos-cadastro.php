                        ...
                        <div class="tab-pane p-20 active" id="cadastro" role="tabpanel">
                            <form id="form_enderecos" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <label class="col-sm-1 col-form-label col-form-label-sm text-right">Estado</label>
                                    <div class="col-sm-2">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control form-control-sm" id="inputHorarioAtendimento" name="inputHorarioAtendimento" placeholder="ex.: Seg a Sáb / 08:00 - 18:00" />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label col-form-label-sm text-right">Telefone</label>
                                    <div class="col-sm-2">
                                        <input type="tel" class="form-control form-control-sm" id="inputTelefone" name="inputTelefone" placeholder="ex.: (45)3333-4444" />
                                    </div>
                                    <label class="col-sm-2 col-form-label col-form-label-sm text-right">Exibir endereço *</label>
                                    <div class="col-sm-2">
                                        <select class="form-control form-control-sm" id="inputExibeEndereco" name="inputExibeEndereco">
