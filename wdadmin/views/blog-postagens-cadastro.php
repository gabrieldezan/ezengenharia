                            ...
                            <form id="form_blog_postagens" method="post" enctype="multipart/form-data" class="form-horizontal">
                                <div class="row">
                                    <div class="col-12 col-sm-3 col-xlg-5">
                                        ...
                                        <div class="form-group">
                                            <label>Autor *</label>
                                            <select class="form-control form-control-sm" id="inputIdAutores" name="inputIdAutores"></select>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="datetime-local" class="form-control form-control-sm" id="inputDataPublicacao" name="inputDataPublicacao" value="<?php echo date('Y-m-d H:i'); ?>" required />
                                        </div>
                                        <div class="form-group">
                                            <label>Status *</label>
                                        ...
                                        <div class="form-group">
                                            <label>Vídeo</label>
                                            <input type="text" class="form-control form-control-sm" id="inputVideo" name="inputVideo" placeholder="Iframe do Youtube" />
                                        </div>
                                        <div class="form-group">
                                            <label>Link da Postagem</label>
                                            <div class="input-group input-group-sm">
                                                <input type="url" class="form-control form-control-sm" id="inputUrl_amigavel" name="inputUrl_amigavel" placeholder="Link da postagem para compartilhamento" disabled />
                                                <div class="input-group-prepend"><button type="button" class="input-group-text" id="copiaTexto" data-toggle="tooltip" title="Copiar Link da notícia"><i class="fas fa-clipboard" aria-hidden="true"></i></button></div>
                                            </div>
                                        </div>
