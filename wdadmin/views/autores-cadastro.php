<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-themecolor">Cadastro de Autores</h3>
    </div>
    <div class="col-md-7 align-self-center">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?php echo URL ?>wdadmin/inicio">Home</a></li>
            <li class="breadcrumb-item"><a href="<?php echo URL ?>wdadmin/autores">Autores</a></li>
            ...
            <div class="card text-center">
                <div class="card-header">
                    <ul class="nav nav-tabs card-header-tabs" role="tablist">
                        ...
                        <li class="botao_novo">
                            <a class="btn btn-info btn-sm" href="<?php echo URL ?>wdadmin/autores/cadastro">
                ...
                <div class="card-body">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane p-20 active" id="cadastro" role="tabpanel">
                            <form id="form_autores" method="post" enctype="multipart/form-data">
                                <input type="hidden" id="inputIdAutores" name="inputIdAutores" value="<?php echo $id ?>" />
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control form-control-sm" id="inputNome" name="inputNome" placeholder="ex.: Web Dezan" required />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label col-form-label-sm text-right">Descrição</label>
                                    <div class="col-sm-8">
                                        <textarea name="inputDescricao" id="inputDescricao" class="form-control form-control-sm" rows="10" placeholder="Descrição do autor"></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
...
<script src="<?php echo URL ?>wdadmin/scripts/autores-cadastro.js"></script>