                        ...
                        <div class="tab-pane p-20 active" id="cadastro" role="tabpanel">
                            <form id="form_depoimentos" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <label class="col-sm-1 col-form-label col-form-label-sm text-right">Empresa</label>
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control form-control-sm" id="inputEmpresa" name="inputEmpresa" placeholder="ex.: Google" />
                                    </div>
                                </div>
                                <div class="form-group row">
