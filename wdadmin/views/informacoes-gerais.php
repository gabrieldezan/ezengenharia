                        ...
                        <div class="tab-pane p-20 active" id="cadastro" role="tabpanel">
                            <form id="form_informacoes_gerais" method="post" enctype="multipart/form-data" autocomplete="off">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control form-control-sm mascaraTelefone" id="inputWhatsApp" name="inputWhatsApp" placeholder="ex.: (00) 00000-0000" />
                                    </div>
                                    <label class="col-sm-2 col-form-label col-form-label-sm text-right">Celular 1</label>
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control form-control-sm mascaraTelefone" id="inputCelular1" name="inputCelular1" placeholder="ex.: (00) 00000-0000" />
                                    </div>
                                    <label class="col-sm-2 col-form-label col-form-label-sm text-right">Celular 2</label>
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control form-control-sm mascaraTelefone" id="inputCelular2" name="inputCelular2" placeholder="ex.: (00) 00000-0000" />
                                    </div>
                                </div>
                                <div class="form-group row">
