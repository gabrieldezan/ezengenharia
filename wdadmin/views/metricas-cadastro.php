<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-themecolor">Cadastro de Métricas</h3>
    </div>
    <div class="col-md-7 align-self-center">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?php echo URL ?>wdadmin/inicio">Home</a></li>
            <li class="breadcrumb-item"><a href="<?php echo URL ?>wdadmin/metricas">Métricas</a></li>
            ...
            <div class="card text-center">
                <div class="card-header">
                    <ul class="nav nav-tabs card-header-tabs" role="tablist">
                        ...
                        <li class="botao_novo">
                            <a class="btn btn-info btn-sm" href="<?php echo URL ?>wdadmin/metricas/cadastro">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane p-20 active" id="cadastro" role="tabpanel">
                            <form id="form_metricas" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label col-form-label-sm text-right">Número *</label>
                                    <div class="col-sm-4">
                                        <input type="number" class="form-control form-control-sm" id="inputNumero" name="inputNumero" placeholder="ex.: 100" required>
                                    </div>
                                    <label class="col-sm-2 col-form-label col-form-label-sm text-right">Medida ou complemento</label>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control form-control-sm" id="inputMedida" name="inputMedida" placeholder="ex.: m²">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label col-form-label-sm text-right">Posição *</label>
                                    <div class="col-sm-4">
                                        <input type="number" class="form-control form-control-sm" id="inputPosicao" name="inputPosicao" placeholder="ex.: 1" required>
                                    </div>
...
<script src="<?php echo URL ?>wdadmin/scripts/metricas-cadastro.js"></script>