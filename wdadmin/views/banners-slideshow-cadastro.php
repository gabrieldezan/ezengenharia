                        ...
                        <div class="tab-pane p-20 active" id="cadastro" role="tabpanel">
                            <form id="form_banners_slideshow" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control form-control-sm" id="inputTitulo" name="inputTitulo" placeholder="Título do banner" />
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control form-control-sm" id="inputTextoBotao" name="inputTextoBotao" placeholder="texto do botão" />
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label col-form-label-sm text-right">Abre link em nova aba? *</label>
                                    <div class="col-sm-3">
                                        <select class="form-control form-control-sm" id="inputLinkNovaAba" name="inputLinkNovaAba">
                                            <option value="1">Sim</option>
                                            <option value="0">Não</option>
                                        </select>
                                    </div>
                                    <label class="col-sm-2 col-form-label col-form-label-sm text-right">Posição</label>
                                    <div class="col-sm-3">
                                        <input type="number" class="form-control form-control-sm" id="inputPosicao" name="inputPosicao">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 col-form-label col-form-label-sm text-right">Orientação vertical da imagem *</label>
                                    <div class="col-sm-3">
                                        <select class="form-control form-control-sm" id="inputOrientacaoVerticalImagem" name="inputOrientacaoVerticalImagem">
                                            <option value="top">Superior</option>
                                            <option value="center">Central</option>
                                            <option value="bottom">Inferior</option>
                                        </select>
                                    </div>
                                    <label class="col-sm-2 col-form-label col-form-label-sm text-right">Orientação horizontal da imagem *</label>
                                    <div class="col-sm-3">
                                        <select class="form-control form-control-sm" id="inputOrientacaoHorizontalImagem" name="inputOrientacaoHorizontalImagem">
