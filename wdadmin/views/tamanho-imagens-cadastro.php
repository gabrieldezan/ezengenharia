<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-themecolor">Cadastro de Tamanho de Imagens</h3>
    </div>
    <div class="col-md-7 align-self-center">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?php echo URL ?>wdadmin/inicio">Home</a></li>
            <li class="breadcrumb-item"><a href="<?php echo URL ?>wdadmin/tamanho-imagens">Tamanho de Imagens</a></li>
                        ...
                        <div class="tab-pane p-20 active" id="cadastro" role="tabpanel">
                            <form id="form_tamanho_imagens" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <label class="col-sm-2 col-form-label col-form-label-sm text-right">Dimensões Thumb</label>
                                    <div class="col-sm-3">
                                        <div class="input-group input-group-sm">
                                            <input type="number" class="form-control form-control-sm" id="inputLarguraThumb" name="inputLarguraThumb" />
                                            <div class="input-group-prepend"><span class="input-group-text">x</span></div>
                                            <input type="number" class="form-control form-control-sm" id="inputAlturaThumb" name="inputAlturaThumb" />
                                            <div class="input-group-prepend"><span class="input-group-text">px</span></div>
                                        </div>
                                        <small class="fileHelp form-text text-muted">Deixe em branco para não gerar a thumb.</small>
                                    </div>
                                </div>
