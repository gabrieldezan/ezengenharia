...
<head>
    ...
    <title>Blog | EZ Engenharia</title>
                ...
                <div class="row">
                    <div class="col-xl-8 col-lg-8 col-sm-12">
                            ...
                            <div class="col-xl-6 col-lg-6">
                                <div class="blog_one_single wow fadeInRight" data-wow-duration="1500ms" data-wow-delay="300ms">
                                    ...
                                    <div class="blog-one__content">
                                        ...
                                        <div class="blog_one_title">
                                            <h3><a href="post.php">Leverage agile frameworks to provide a robust</a>
                                            </h3>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="text-center blog-page__load-more">
                            <a href="blog.php" class="thm-btn">Ver mais</a>
                        </div>
                    </div>
                    <?php /*SIDEBAR*/
                    include('php/sidebarBlog.php');
                    ?>
                </div>
