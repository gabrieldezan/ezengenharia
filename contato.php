...
<head>
    ...
    <title>Contato | EZ Engenharia</title>
...
<body>
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-4">
                            <div class="all_contact_info_single mail_info">
                                ...
                                <div class="content">
                                    <a href="mailto:contato@ezengenharia.com.br">contato@ezengenharia.com.br</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4">
                        ...
                        <div class="col-xl-4 col-lg-4"> 
                            <div class="all_contact_info_single location_info">
                                ...
                                <div class="content">
                                    <p>Suite 80 Golden Street Line <br> New York, USA</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-5">
                        <div class="contact_one_left">
                            ...
                            <div class="contact_one_left__social">
                                <a href="#" class="tw-clr"><i class="fab fa-whatsapp"></i></a>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="input-group contact__btn">
                                            <button type="submit" class="thm-btn contact-one__btn full-width">Enviar</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
    ...
    <div class="mobile-nav__wrapper">
        ...
        <div class="mobile-nav__content">
            ...
            <div class="logo-box">
                <a href="index.php" aria-label="logo image"><img src="assets/images/logo.png" width="101" alt="" /></a>
            </div>
